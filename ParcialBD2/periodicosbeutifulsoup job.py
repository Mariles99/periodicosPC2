...
extraerTiempo("headlines/raw/El_Tiempo-"+str(date_day.year)+"-"+str(date_day.strftime('%m'))+"-"+str(date_day.strftime('%d'))+".html")
extraerEspectador("headlines/raw/El_Espectador-"+str(date_day.year)+"-"+str(date_day.strftime('%m'))+"-"+str(date_day.strftime('%d'))+".html")